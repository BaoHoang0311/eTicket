...
namespace web_movie.Data
{
    ...
    {
        public static void Seed(IApplicationBuilder applicationbuilklder)
        {
            using (var serviceScope = applicationbuilklder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Actors.Any())
                {
                    context.Actors.AddRange(new List<Actor>()
                    {
                        ...
                        {
                            FullName = "Actor 1",
                            Bio = "This is the Bio of the 1 actor",
